  ...
  <div class="content-wrapper">
    ...
    <div class="card-body">
        ...
        {{ csrf_field() }}
            ...
            <label for="nama_sup">Nama</label>
            <input type="text" class="form-control" name="nama_sup" required/>
            </div>
            <div class="form-group">
            <label for="no_sup">Telepon</label>
            <input type="text" class="form-control" name="no_sup" required/>
            </div>
            <div class="form-group">
            <label for="alamat_sup">Alamat</label>
            <input type="text" class="form-control" name="alamat_sup" required/>
