...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="assets/img/AdminLTELogo.png" alt="" class="brand-image img-circle elevation-3"
           style="opacity: .3">
      <span class="brand-text font-weight-bold">Logistik</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="pages/barang.html" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pages/supplier.html" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pages/masuk.html" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pages/keluar.html" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="resources/views/simple.html" class="nav-link">
