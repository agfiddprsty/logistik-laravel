  ...
  <div class="content-wrapper">
    ...
    <div class="card-body">
        ...
        {{ csrf_field() }}
            ...
            <select class="kode_brg form-control custom-select"  name="kode_brg" id="kode_brg" required>
              @if(count($kode_brg) > 0)
                @foreach($kode_brg as $key => $brg)
              <option value="{{$brg->kode_brg}}">{{$brg->kode_brg}}</option>
                @endforeach
              @endif
            </select>
            ...
            <label for="kategori_brg">Kategori Barang</label>
                <select name="kategori_brg" class="custom-select" id="kategori_brg">
            ...
            <input type="text" class="form-control" name="nama_sup" id="nama_sup" required/><br/>
    ...
    $.ajax({
        ...
        success: function(response){
            if(response != null){ 
                ...
                $('#kategori_brg').val(response.kategori_brg);
                $('#satuan').val(response.satuan);
                $('#nama_sup').val(response.nama_sup);
            }
        }
    });
});
